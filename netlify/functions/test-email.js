...
<body style="margin:0;padding:0;font-family:system-ui,-apple-system,sans-serif;background:#f9f9f9;">
  <div style="max-width:520px;margin:40px auto;background:#fff;border-radius:12px;overflow:hidden;box-shadow:0 2px 12px rgba(0,0,0,0.07);">
    ...
    <div style="padding:32px;">
      <p style="margin:0 0 6px;font-size:15px;color:#111;">Hi Angelica,</p>
      <p style="margin:0 0 24px;font-size:14px;color:#555;">Here's your payout summary for <strong>9 Jun – 15 Jun 2026</strong>.</p>
      <table style="width:100%;border-collapse:collapse;font-size:14px;">
        ...
        <tbody>
          <tr>
            <td style="padding:8px 12px;border-bottom:1px solid #f0f0f0;">2026-06-10</td>
            <td style="padding:8px 12px;border-bottom:1px solid #f0f0f0;">Priya Sharma</td>
            <td style="padding:8px 12px;border-bottom:1px solid #f0f0f0;text-align:right;">$55.00</td>
          </tr>
          <tr>
            <td style="padding:8px 12px;border-bottom:1px solid #f0f0f0;">2026-06-13</td>
            <td style="padding:8px 12px;border-bottom:1px solid #f0f0f0;">Yuki Tanaka</td>
            <td style="padding:8px 12px;border-bottom:1px solid #f0f0f0;text-align:right;">$55.00</td>
          </tr>
        </tbody>
        <tfoot>
          <tr>
            ...
            <td style="padding:14px 12px;font-weight:700;font-size:15px;color:#111;text-align:right;">$110.00 AUD</td>
          </tr>
        </tfoot>
      </table>
  ...
  const res = await fetch("https://api.brevo.com/v3/smtp/email", {
    ...
    body: JSON.stringify({
      ...
      subject:     "Test Payslip — The Headstart",
      htmlContent: html,
    }),
  });
  ...
  return {
    ...
    headers,
    body: JSON.stringify({ success: res.ok, status: res.status }),
  };
};
