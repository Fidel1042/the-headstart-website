// Option lists used by the search-select inputs across signup forms.
...
export const searchSources = {
  ...
  "country-codes": [
    "AF +93", "AL +355", "DZ +213", "AS +1-684", "AD +376", "AQ +672",
    "AO +244", "AI +1-264", "AG +1-268", "AR +54", "AM +374", "AW +297",
    "AX +358", "AU +61", "AT +43", "AZ +994", "BS +1-242", "BH +973",
    "BD +880", "BB +1-246", "BY +375", "BE +32", "BZ +501", "BJ +229",
    "BM +1-441", "BT +975", "BO +591", "BQ +599", "BA +387", "BW +267",
    ...
    "GR +30", "GS +500", "GL +299", "GD +1-473", "GP +590", "GU +1-671",
    "GT +502", "GG +44", "GN +224", "GW +245", "GY +592", "HT +509",
    "HN +504", "HK +852", "HU +36", "IS +354", "IN +91", "ID +62",
    "IR +98", "IQ +964", "IE +353", "IM +44", "JE +44", "IL +972",
    "IT +39", "JM +1-876", "JP +81", "JO +962", "KZ +7", "KE +254",
    "KI +686", "KP +850", "XK +383", "KR +82", "KW +965", "KG +996",
    ...
    "PL +48", "PT +351", "PR +1-787", "QA +974", "RE +262", "RO +40",
    "RU +7", "RW +250", "BL +590", "SH +290", "KN +1-869", "LC +1-758",
    "MF +590", "PM +508", "VC +1-784", "WS +685", "SM +378", "ST +239",
    "SA +966", "SN +221", "RS +381", "SC +248", "SL +232", "SG +65",
    "SX +1-721", "SK +421", "SI +386", "SB +677", "SO +252", "ZA +27",
    ...
    "UA +380", "AE +971", "UK +44", "US +1", "UY +598", "UZ +998",
    "VU +678", "VA +379", "VE +58", "VN +84", "VG +1-284", "VI +1-340",
